...
if (numa)
  message(STATUS "Looking for libnuma")
  message(STATUS "LIBNUMA_INCLUDE_DIRS = ${LIBNUMA_INCLUDE_DIRS}")
  message(STATUS "LIBNUMA_LIBRARIES = ${LIBNUMA_LIBRARIES}")
  message(STATUS "numa_description = ${numa_description}")
  message(STATUS "LIBNUMA_FOUND = ${LIBNUMA_FOUND}")
  find_package(libnuma)
  if(NOT LIBNUMA_FOUND)
    if(fail-on-missing)
      message(FATAL_ERROR "libnuma not found and numa option required")
    else()
      message(STATUS "libnuma not found. Switching off numa option")
      set(numa OFF CACHE BOOL "Disabled because libnuma was not found (${numa_description})" FORCE)
    endif()
  endif()
endif()
